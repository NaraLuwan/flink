...
import greeter.types.UserLogin;
...
import static greeter.types.Types.USER_LOGIN_JSON_TYPE;
import static greeter.types.Types.USER_PROFILE_PROTOBUF_TYPE;
 ...
 * function in-turn invokes {@link org.apache.flink.statefun.playground.java.greeter.GreetingsFn} with the user information to generate a personalized
 * greetings message.
 */
final class UserFn implements StatefulFunction {
  ...
  public CompletableFuture<Void> apply(Context context, Message message) {
    if (message.is(USER_LOGIN_JSON_TYPE)) {
      ...
      context.send(
          MessageBuilder.forAddress(org.apache.flink.statefun.playground.java.greeter.GreetingsFn.TYPENAME, login.getUserId())
